...
Int_t Minimize(int sys=0,int trig,int pt,int frame){
	...
	Double_t scan1list[4]={1,1000,-1.,1.};
	Double_t scan2list[4]={2,1000,-1.,1.};
	Double_t scan3list[4]={3,1000,-1.,1.};
...
void sPlot3D_2eid_inv30_test(int trig=1,int pt=1,int frame=1,int sys=0) {
