...
//						if((isTrg1[0] && isTpc2[0] && isTOF2) || (isTrg2[0] && isTpc1[0] && isTOF1) || (isEmc2 && isTrg1[0]) || (isEmc1 && isTrg2[0])) { //20161219
...
//						if((isTrg1[1] && isEmc1 && isTpc2[1])||(isTrg2[1] && isEmc2 && isTpc1[1]) || (isEmc1 && isEmc2 && isTrg1[1]) || (isEmc1 && isEmc2 && isTrg2[1])) {
